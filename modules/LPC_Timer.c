 ...
 *              0: success
 *   non-zero: error number
 * Description: Get corresponding matching information for specific timer.
 *
 *************************************************************************/
int TIMER_GetTimerMatch(LPC_TimerChannel_t DevNum, unsigned int MRNum,
 ...
 *              0: success
 *   non-zero: error number
 * Description: Get corresponding external matching information from specific timer.
 *
 *************************************************************************/
 ...
 *              0: success
 *   non-zero: error number
 * Description: Get corresponding capture information from specific timer.
 *
 *************************************************************************/
                              ...
                              void * FnprArg )
{
  ...
  {
  case TIMER0:
    if (CPCHNum > CPCH_MAXNUM-1)  // for timer 0 capture channel 3 is not exist
      return 1;
  ...
  case TIMER1:
    ...
    case CH2:
      if (TriggerType == 0)
        ...
        PINSEL1_bit.P0_17 = 0x1;
      break;
    case CH3:
      if (TriggerType == 0)
        PINSEL1_bit.P0_18 = 0;
      else
        PINSEL1_bit.P0_18 = 0x1;
      break;
    }
    //Set Capture on Rising Edge
    if (TriggerType & TimerCPTrigger_Rising)
