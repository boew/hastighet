...
{
  {MENU_TICK_EVENT,MENU_TIME_AND_DATA_SHOW,0,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,NULL},
...
{
  {MENU_TICK_EVENT,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,NULL},
...
{
  {MENU_TICK_EVENT,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed},
...
/* Return to Time and Data show */
const MENU_ACTION_SHAIN_DEF MenuActionEventChain5 [] =
{
  {MENU_TICK_EVENT,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,NULL},
  {MENU_EVENT_B1_SHORT_PRESS,MENU_ADC_MEASURE,MENU_TO_DLY,NULL,NULL,NULL},
  {MENU_EVENT_B2_SHORT_PRESS,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,NULL},
  {0,0,MENU_TIME_OUT_NOT_UPADATE,NULL,NULL,NULL},
};
...
const MENU_ACTION_SHAIN_DEF MenuActionEventChain6 [] =
{
  ...
  {MENU_EVENT_TIME_UPDATE,0,MENU_TIME_OUT_NOT_UPADATE,NULL,GetDistAndSpeed,NULL},
  {0,0,MENU_TIME_OUT_NOT_UPADATE,NULL,NULL,NULL},
};
...
const MENU_ACTION_SHAIN_DEF MenuActionEventChain7 [] =
{
  ...
  {MENU_EVENT_B1_SHORT_PRESS,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,NULL},
  {MENU_EVENT_B2_SHORT_PRESS,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,NULL},
  {0,0,MENU_TIME_OUT_NOT_UPADATE,NULL,NULL,NULL},
};
...
const MENU_ACTION_SHAIN_DEF MenuActionEventChain8 [] =
{
  ...
  {0,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,NULL},
};
...
{
  {MENU_TICK_EVENT,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetDistAndSpeed,CursorOff},
