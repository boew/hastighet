...
{
  {MENU_TICK_EVENT,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetTimeAndSpeed},
...
const MENU_ACTION_SHAIN_DEF MenuActionEventChain5 [] =
{
  ...
  {MENU_EVENT_B2_SHORT_PRESS,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetTimeAndSpeed,NULL},
  {0,0,MENU_TIME_OUT_NOT_UPADATE,NULL,NULL,NULL},
};
...
const MENU_ACTION_SHAIN_DEF MenuActionEventChain6 [] =
{
  ...
  {MENU_EVENT_TIME_UPDATE,0,MENU_TIME_OUT_NOT_UPADATE,NULL,GetTimeAndSpeed,NULL},
  {0,0,MENU_TIME_OUT_NOT_UPADATE,NULL,NULL,NULL},
};
...
const MENU_ACTION_SHAIN_DEF MenuActionEventChain7 [] =
{
  ...
  {MENU_EVENT_B1_SHORT_PRESS,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetTimeAndSpeed,NULL},
  {MENU_EVENT_B2_SHORT_PRESS,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetTimeAndSpeed,NULL},
  {0,0,MENU_TIME_OUT_NOT_UPADATE,NULL,NULL,NULL},
};
...
const MENU_ACTION_SHAIN_DEF MenuActionEventChain8 [] =
{
  ...
  {0,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetTimeAndSpeed,NULL},
};
...
{
  {MENU_TICK_EVENT,MENU_TIME_AND_DATA_SHOW,MENU_SCREEN_SAVER_DLY,(MEMU_STING_DEF *)ArgFormate,GetTimeAndSpeed,CursorOff},
